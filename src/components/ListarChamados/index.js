    ...
    return (
        ...
        <section className="mb-4 container">
                    <article className="d-flex justify-content-between">
                        <h3 className="cor-azul-escuro">Seus chamados: </h3>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer d-flex justify-content-center">
                                                        ...
                                                        <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal" onClick={() => {excluirChamado(element.id).then(() => 
             window.location.reload())}}>Excluir</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 d-flex botoes-edicao">
                                        <button className="btn btn-crud-chamado " type="button" data-bs-toggle="modal" data-bs-target="#editar" onClick={() => {
                                            setId(element.id);
